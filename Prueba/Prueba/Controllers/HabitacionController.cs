...
namespace Prueba.Controllers
{
    ...
    public class HabitacionController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateHabitacion(Habitacion habitacion)
        {
            ...
            if (habitacion.Costo < 20 || habitacion.Costo > 300)
            {
        ...
        public async Task<IActionResult> EditHabitacion(int id, Habitacion habitacion)
        {
            ...
            if (habitacion.Costo <= 0 || habitacion.Costo > 300)
            {
                return Ok("El costo debe ser entre 0 y 300");
            }
            ...
            habitacionExistente.Lugar = habitacion.Lugar;
